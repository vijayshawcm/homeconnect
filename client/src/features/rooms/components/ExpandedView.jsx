...
import ApplianceAutomationButton from './ApplianceAutomationButton';
import ApplianceSchedulerButton from './ApplianceSchedulerButton';
						...
						<div className="h-[30%] flex justify-center items-end">
							{isSettingsExpanded ? (
								...
								<div className="flex flex-col gap-2 w-full">
									...
									<ApplianceAutomationButton />
									<ApplianceSchedulerButton />
